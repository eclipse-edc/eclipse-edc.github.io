...
<!-- TOC -->
  * [1. API controllers](#1-api-controllers)
    ...
    * [1.4 API Authentication](#14-api-authentication)
      * [1.4.1 Manual Authentication wiring](#141-manual-authentication-wiring) 
      * [1.4.1 Authentication Configuration](#142-authentication-configuration) 
...
#### 1.4.1 Manual authentication wiring
...
#### 1.4.2 Authentication configuration
