...
This document should give you, the contributor, some guidance in how AI tools are used, and what to expect when ignoring the rules.
...
Be mindful that the legal opinion on AI-generated content with regards to copyright is anything but well-established at this point, and do confirm with your employer whether they have any relevant policies in place.

AI is imperfect, it makes mistakes and can be outright hallucinating at times, so a human developer **must review** its output before a contribution is made. The human contributor is responsible for the content!
 ...
 * 
 * generated with Claude Agent via IntelliJ AI Agent
...
Committers are required to review every contribution made to the project, which is a very time-consuming task to begin with. This task quickly turns into a _waste of time_ if the contribution is largely AI-generated and was not properly vetted by a human contributor beforehand. AI content may contain errors, incorrect assumptions or other falsehoods and contributors should make an effort to catch that.
